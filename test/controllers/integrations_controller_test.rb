...
class IntegrationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create integration" do
    assert_difference('Integration.count') do
      post integrations_url, params: { integration: { api_key: @integration.api_key, password: @integration.password, store_name: @integration.store_name, type: @integration.type, user_id: @integration.user_id } }
    end
  ...
  test "should update integration" do
    patch integration_url(@integration), params: { integration: { api_key: @integration.api_key, password: @integration.password, store_name: @integration.store_name, type: @integration.type, user_id: @integration.user_id } }
